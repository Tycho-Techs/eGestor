                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                      ...
                      <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="../../../egestor/index.html">e-Gestor</a>
                        <p class="opacity-75 text-white">Chega de anotar dados importantes em papéis e planilhas.<br />O e-Gestor organiza e facilita a administração do seu negócio.<br /><br />Geramos informações para você tomar decisões mais assertivas e aumentar a produtividade da sua empresa.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center"><img class="d-block mx-auto mb-4" src="../../../assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                        <h3>Espero ver você em breve!</h3>
                        <p>Obrigado por usar Egestor. Você foi <br />desconectado com sucesso.</p><a class="btn btn-primary btn-sm mt-3" href="../../../egestor/login.php"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Retornar para Login</a>
                      </div>
                    </div>
                  </div>
                </div>

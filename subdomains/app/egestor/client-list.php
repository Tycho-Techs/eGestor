                  ...
                  <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                    ...
                    <div class="d-flex align-items-center" id="table-contact-replace-element">
                      <!-- <button class="btn btn-falcon-success btn-sm" type="button">
                                <span class="fas fa-plus" data-fa-transform="shrink-3"></span><span class="d-none d-sm-inline-block d-xl-none d-xxl-inline-block ms-1">Novo</span>
                            </button> -->
                ...
                <div class="table-responsive scrollbar">
                  <table class="table table-sm fs--1 mb-0">
                    <thead class="text-800 bg-light">
                      <tr>
                        <th class="sort align-middle cnpj" data-sort="cnpj">CNPJ</th>
                        <th class="sort align-middle nome-fantasia" data-sort="nome-fantasia">Cliente</th>
                        <th class="sort align-middle razao-social" data-sort="razao-social">Razão Social</th>
                        <th class="sort align-middle cidade" data-sort="cidade">Cidade</th>
                        <th class="sort align-middle uf" data-sort="uf">UF</th>
                    ...
                    <tbody class="list" id="table-contact-body">
                      ...
                      <?php
                        ...
                        $sql = mysqli_query($conn_egestor, "SELECT * FROM eg_cad_Clientes") or die( mysqli_error($conn_egestor));
                        while($dados = mysqli_fetch_assoc($sql)) {
                            ...
                            Echo'
                                <tr>
                                <td class="align-middle cnpj font-sans-serif white-space-nowrap">'.$docfsc_dest.'</td>
                                <td class="align-middle nome-fantaisa white-space-nowrap pe-5 ps-2">
                                  <div class="d-flex align-items-center gap-2 position-relative">
                                    ...
                                    <h6 class="mb-0"><a class="stretched-link text-900"
                                        href="../../egestor/client-details.php?docfsc='.$dados['docfsc'].'">'.$dados['nome_fantasia'].'</a></h6>
                                  </div>
                                </td>
                                <td class="align-middle razao-social">'.$dados['razao_social'].'</td>
                                <td class="align-middle cidade">'.$dados['cidade'].'</td>
                                <td class="align-middle uf">'.$dados['uf'].'</td>
